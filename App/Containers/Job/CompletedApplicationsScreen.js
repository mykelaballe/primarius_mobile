...
class CompletedApplicationsScreen extends React.Component {

    state = {
        list: this.props.navigation.state.params.Job.completed_applicants
    }
            ...
            <Section>
                <Row f>
                    ...
                    <View>
                        ...
                        <Text sm mute>Date Completed: {moment(item.updated_at).format('YYYY-MM-DD')}</Text>
                    </View>
                </Row>
            </Section>
        )
...
export default connect(mapStateToProps)(CompletedApplicationsScreen)